...
function createBaseRequestInitChain(): RequestInitChain {
    return { time: undefined, chainId: '', consensusParams: undefined, validators: [], appStateBytes: new Uint8Array(), initialHeight: Long.ZERO };
}
...
function createBaseResponseInfo(): ResponseInfo {
    return { data: '', version: '', appVersion: Long.UZERO, lastBlockHeight: Long.ZERO, lastBlockAppHash: new Uint8Array() };
}
...
function createBaseResponseQuery(): ResponseQuery {
    return { code: 0, log: '', info: '', index: Long.ZERO, key: new Uint8Array(), value: new Uint8Array(), proofOps: undefined, height: Long.ZERO, codespace: '' };
}
...
function createBaseResponseCheckTx(): ResponseCheckTx {
    return { code: 0, data: new Uint8Array(), log: '', info: '', gasWanted: Long.ZERO, gasUsed: Long.ZERO, events: [], codespace: '' };
}
