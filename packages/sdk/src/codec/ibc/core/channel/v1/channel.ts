...
function createBasePacket(): Packet {
    return { sequence: Long.UZERO, sourcePort: '', sourceChannel: '', destinationPort: '', destinationChannel: '', data: new Uint8Array(), timeoutHeight: undefined, timeoutTimestamp: Long.UZERO };
}
