...
function createBaseMsgChannelOpenTry(): MsgChannelOpenTry {
    return { portId: '', previousChannelId: '', channel: undefined, counterpartyVersion: '', proofInit: new Uint8Array(), proofHeight: undefined, signer: '' };
}
...
function createBaseMsgChannelOpenAck(): MsgChannelOpenAck {
    return { portId: '', channelId: '', counterpartyChannelId: '', counterpartyVersion: '', proofTry: new Uint8Array(), proofHeight: undefined, signer: '' };
}
...
function createBaseMsgTimeout(): MsgTimeout {
    return { packet: undefined, proofUnreceived: new Uint8Array(), proofHeight: undefined, nextSequenceRecv: Long.UZERO, signer: '' };
}
...
function createBaseMsgTimeoutOnClose(): MsgTimeoutOnClose {
    return { packet: undefined, proofUnreceived: new Uint8Array(), proofClose: new Uint8Array(), proofHeight: undefined, nextSequenceRecv: Long.UZERO, signer: '' };
}
...
function createBaseMsgAcknowledgement(): MsgAcknowledgement {
    return { packet: undefined, acknowledgement: new Uint8Array(), proofAcked: new Uint8Array(), proofHeight: undefined, signer: '' };
}
