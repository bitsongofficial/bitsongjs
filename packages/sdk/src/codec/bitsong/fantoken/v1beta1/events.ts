...
export const EventIssue = {
    ...
    fromPartial<I extends Exact<DeepPartial<EventIssue>, I>>(object: I): EventIssue {
        const message = createBaseEventIssue();
...
export const EventDisableMint = {
    ...
    fromPartial<I extends Exact<DeepPartial<EventDisableMint>, I>>(object: I): EventDisableMint {
        const message = createBaseEventDisableMint();
        message.denom = object.denom ?? '';
        return message;
    },
...
export const EventSetAuthority = {
    ...
    fromPartial<I extends Exact<DeepPartial<EventSetAuthority>, I>>(object: I): EventSetAuthority {
        const message = createBaseEventSetAuthority();
        message.denom = object.denom ?? '';
...
export const EventSetMinter = {
    ...
    fromPartial<I extends Exact<DeepPartial<EventSetMinter>, I>>(object: I): EventSetMinter {
        const message = createBaseEventSetMinter();
        message.denom = object.denom ?? '';
...
export const EventSetUri = {
    ...
    fromPartial<I extends Exact<DeepPartial<EventSetUri>, I>>(object: I): EventSetUri {
        const message = createBaseEventSetUri();
        message.denom = object.denom ?? '';
        return message;
    },
