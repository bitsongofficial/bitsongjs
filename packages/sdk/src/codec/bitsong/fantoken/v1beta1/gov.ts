...
function createBaseUpdateFeesProposal(): UpdateFeesProposal {
    return { title: '', description: '', issueFee: undefined, mintFee: undefined, burnFee: undefined };
}
...
export const UpdateFeesProposal = {
    ...
    fromPartial<I extends Exact<DeepPartial<UpdateFeesProposal>, I>>(object: I): UpdateFeesProposal {
        const message = createBaseUpdateFeesProposal();
...
function createBaseUpdateFeesProposalWithDeposit(): UpdateFeesProposalWithDeposit {
    return { title: '', description: '', issueFee: '', mintFee: '', burnFee: '', deposit: '' };
}
...
export const UpdateFeesProposalWithDeposit = {
    ...
    fromPartial<I extends Exact<DeepPartial<UpdateFeesProposalWithDeposit>, I>>(object: I): UpdateFeesProposalWithDeposit {
        const message = createBaseUpdateFeesProposalWithDeposit();
        message.title = object.title ?? '';
        message.description = object.description ?? '';
