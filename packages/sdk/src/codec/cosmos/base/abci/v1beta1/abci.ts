...
function createBaseTxResponse(): TxResponse {
    return { height: Long.ZERO, txhash: '', codespace: '', code: 0, data: '', rawLog: '', logs: [], info: '', gasWanted: Long.ZERO, gasUsed: Long.ZERO, tx: undefined, timestamp: '', events: [] };
}
...
function createBaseSearchTxsResult(): SearchTxsResult {
    return { totalCount: Long.UZERO, count: Long.UZERO, pageNumber: Long.UZERO, pageTotal: Long.UZERO, limit: Long.UZERO, txs: [] };
}
