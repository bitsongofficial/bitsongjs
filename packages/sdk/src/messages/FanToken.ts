...
import { MsgIssue, MsgMint, MsgDisableMint, MsgBurn, MsgSetMinter, MsgSetAuthority, MsgSetUri } from '../codec/bitsong/fantoken/v1beta1/tx';
...
export interface MsgMintEncodeObject extends EncodeObject {
  readonly typeUrl: '/bitsong.fantoken.MsgMint';
