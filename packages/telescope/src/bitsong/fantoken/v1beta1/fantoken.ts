...
export const Metadata = {
  ...
  is(o: any): o is Metadata {
    return o && (o.$typeUrl === Metadata.typeUrl || typeof o.name === "string" && typeof o.symbol === "string" && typeof o.uri === "string" && typeof o.authority === "string");
  },
...
export const FanToken = {
  typeUrl: "/bitsong.fantoken.v1beta1.FanToken",
  is(o: any): o is FanToken {
    return o && (o.$typeUrl === FanToken.typeUrl || typeof o.denom === "string" && typeof o.maxSupply === "string" && typeof o.minter === "string" && Metadata.is(o.metaData));
  },
  isSDK(o: any): o is FanTokenSDKType {
    return o && (o.$typeUrl === FanToken.typeUrl || typeof o.denom === "string" && typeof o.max_supply === "string" && typeof o.minter === "string" && Metadata.isSDK(o.meta_data));
  },
  isAmino(o: any): o is FanTokenAmino {
    return o && (o.$typeUrl === FanToken.typeUrl || typeof o.denom === "string" && typeof o.max_supply === "string" && typeof o.minter === "string" && Metadata.isAmino(o.meta_data));
  },
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FanToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
GlobalDecoderRegistry.register(FanToken.typeUrl, FanToken);