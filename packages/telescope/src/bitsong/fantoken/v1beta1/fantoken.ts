 ...
 * @see proto type: bitsong.fantoken.v1beta1.Metadata
 */
 ...
 * @name FanToken
 * @package bitsong.fantoken.v1beta1
 * @see proto type: bitsong.fantoken.v1beta1.FanToken
 */
...
export const FanToken = {
  ...
  registerTypeUrl() {
    if (!GlobalDecoderRegistry.registerExistingTypeUrl(FanToken.typeUrl)) {
      return;
    }
