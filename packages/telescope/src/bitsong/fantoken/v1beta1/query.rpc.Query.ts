...
export class QueryClientImpl implements Query {
  ...
  fanToken(request: QueryFanTokenRequest): Promise<QueryFanTokenResponse> {
    ...
    return promise.then(data => QueryFanTokenResponse.decode(new BinaryReader(data)));
  }
  fanTokens(request: QueryFanTokensRequest): Promise<QueryFanTokensResponse> {
    ...
    return promise.then(data => QueryFanTokensResponse.decode(new BinaryReader(data)));
  }
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
