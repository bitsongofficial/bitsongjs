...
export const EventIssue = {
  ...
  isSDK(o: any): o is EventIssueSDKType {
    return o && (o.$typeUrl === EventIssue.typeUrl || typeof o.denom === "string");
  },
...
GlobalDecoderRegistry.register(EventIssue.typeUrl, EventIssue);
...
export const EventDisableMint = {
  ...
  isSDK(o: any): o is EventDisableMintSDKType {
    return o && (o.$typeUrl === EventDisableMint.typeUrl || typeof o.denom === "string");
  },
...
GlobalDecoderRegistry.register(EventDisableMint.typeUrl, EventDisableMint);
...
export const EventSetAuthority = {
  ...
  isSDK(o: any): o is EventSetAuthoritySDKType {
...
GlobalDecoderRegistry.register(EventSetAuthority.typeUrl, EventSetAuthority);
...
export const EventSetMinter = {
  ...
  isSDK(o: any): o is EventSetMinterSDKType {
...
GlobalDecoderRegistry.register(EventSetMinter.typeUrl, EventSetMinter);
...
export const EventSetUri = {
  ...
  isSDK(o: any): o is EventSetUriSDKType {
    return o && (o.$typeUrl === EventSetUri.typeUrl || typeof o.denom === "string");
  },
...
GlobalDecoderRegistry.register(EventSetUri.typeUrl, EventSetUri);