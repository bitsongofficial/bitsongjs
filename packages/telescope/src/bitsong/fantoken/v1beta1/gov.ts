...
export const UpdateFeesProposal = {
  ...
  isSDK(o: any): o is UpdateFeesProposalSDKType {
    return o && (o.$typeUrl === UpdateFeesProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Coin.isSDK(o.issue_fee) && Coin.isSDK(o.mint_fee) && Coin.isSDK(o.burn_fee));
  },
...
GlobalDecoderRegistry.register(UpdateFeesProposal.typeUrl, UpdateFeesProposal);
...
export const UpdateFeesProposalWithDeposit = {
  ...
  isSDK(o: any): o is UpdateFeesProposalWithDepositSDKType {
...
GlobalDecoderRegistry.register(UpdateFeesProposalWithDeposit.typeUrl, UpdateFeesProposalWithDeposit);