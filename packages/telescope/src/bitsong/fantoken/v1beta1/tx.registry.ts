...
export const registry: ReadonlyArray<[string, TelescopeGeneratedType<any, any, any>]> = [["/bitsong.fantoken.v1beta1.MsgIssue", MsgIssue], ["/bitsong.fantoken.v1beta1.MsgMint", MsgMint], ["/bitsong.fantoken.v1beta1.MsgBurn", MsgBurn], ["/bitsong.fantoken.v1beta1.MsgDisableMint", MsgDisableMint], ["/bitsong.fantoken.v1beta1.MsgSetMinter", MsgSetMinter], ["/bitsong.fantoken.v1beta1.MsgSetAuthority", MsgSetAuthority], ["/bitsong.fantoken.v1beta1.MsgSetUri", MsgSetUri]];
