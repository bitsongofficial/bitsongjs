...
export const QueryFanTokenRequest = {
  ...
  isSDK(o: any): o is QueryFanTokenRequestSDKType {
    return o && (o.$typeUrl === QueryFanTokenRequest.typeUrl || typeof o.denom === "string");
  },
...
GlobalDecoderRegistry.register(QueryFanTokenRequest.typeUrl, QueryFanTokenRequest);
...
export const QueryFanTokenResponse = {
  ...
  isSDK(o: any): o is QueryFanTokenResponseSDKType {
    return o && o.$typeUrl === QueryFanTokenResponse.typeUrl;
  },
...
GlobalDecoderRegistry.register(QueryFanTokenResponse.typeUrl, QueryFanTokenResponse);
...
export const QueryFanTokensRequest = {
  ...
  isSDK(o: any): o is QueryFanTokensRequestSDKType {
    return o && (o.$typeUrl === QueryFanTokensRequest.typeUrl || typeof o.authority === "string");
  },
...
GlobalDecoderRegistry.register(QueryFanTokensRequest.typeUrl, QueryFanTokensRequest);
...
export const QueryFanTokensResponse = {
  ...
  isSDK(o: any): o is QueryFanTokensResponseSDKType {
    return o && (o.$typeUrl === QueryFanTokensResponse.typeUrl || Array.isArray(o.fantokens) && (!o.fantokens.length || FanToken.isSDK(o.fantokens[0])));
  },
...
GlobalDecoderRegistry.register(QueryFanTokensResponse.typeUrl, QueryFanTokensResponse);
