 ...
 * @see proto type: bitsong.smartaccount.v1beta1.AccountAuthenticator
 */
...
export interface AccountAuthenticatorProtoMsg {
  typeUrl: "/bitsong.smartaccount.v1beta1.AccountAuthenticator";
  value: Uint8Array;
}
/**
 * AccountAuthenticator represents a foundational model for all authenticators.
...
export interface AccountAuthenticatorAminoMsg {
  type: "/bitsong.smartaccount.v1beta1.AccountAuthenticator";
