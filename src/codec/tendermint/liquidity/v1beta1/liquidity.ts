...
const basePool: object = { id: Long.UZERO, typeId: 0, reserveCoinDenoms: '', reserveAccountAddress: '', poolCoinDenom: '' };
...
const basePoolBatch: object = { poolId: Long.UZERO, index: Long.UZERO, beginHeight: Long.ZERO, depositMsgIndex: Long.UZERO, withdrawMsgIndex: Long.UZERO, swapMsgIndex: Long.UZERO, executed: false };
...
const baseDepositMsgState: object = { msgHeight: Long.ZERO, msgIndex: Long.UZERO, executed: false, succeeded: false, toBeDeleted: false };
...
const baseWithdrawMsgState: object = { msgHeight: Long.ZERO, msgIndex: Long.UZERO, executed: false, succeeded: false, toBeDeleted: false };
...
const baseSwapMsgState: object = { msgHeight: Long.ZERO, msgIndex: Long.UZERO, executed: false, succeeded: false, toBeDeleted: false, orderExpiryHeight: Long.ZERO };
