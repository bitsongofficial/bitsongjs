...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var wallet, account, bitsong, signingBitsong, denom, amount, result, balance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                console.log('burning a fantoken...');
                denom = 'utest22';
                amount = '10000000';
                return [4 /*yield*/, signingBitsong.burnFanToken(denom, amount, account.address, defaultFee)];
            case 5:
                result = _a.sent();
